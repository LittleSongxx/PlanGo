...
from planora.agent.contracts import ActionResult, MemoryProposal, PlanCandidate, TripSpec
from planora.agent.decisions import ReflectionOutput
...
class ReflectionAgent:
    ...
    async def run(
        ...
        output = await self.model.structured(
            ReflectionOutput,
            system=(
                "你是 Planora 的 Reflection Agent。只从已发生的任务终态中提炼可复用记忆。"
