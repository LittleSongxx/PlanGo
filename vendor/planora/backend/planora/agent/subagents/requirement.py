...
from planora.agent.contracts import Activity, PartyMember, TripSpec
from planora.agent.decisions import RequirementOutput
...
class RequirementAgent:
    ...
    async def run(
        ...
        output = await self.model.structured(
            RequirementOutput,
            system=(
                "你是 Planora 的 Requirement Agent。把用户的本地生活目标转换为结构化约束。"
