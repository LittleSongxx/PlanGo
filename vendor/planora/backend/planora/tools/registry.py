...
from planora.agent.contracts import ActionItem, ActionProposal, Location, PlanCandidate, TripSpec
from planora.domain.planning import PlanEngine, ToolBudgetExceeded
...
from planora.providers.world import WorldProvider, WorldProviderError
            ...
            out.append(
                {
                    ...
                    "x-planora-read-only": spec.read_only,
                    "x-planora-risk": spec.risk,
                }
            )
        return out
